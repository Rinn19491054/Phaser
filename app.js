...
//positioning the lives
 lifelabel = game.add.text(10,5, "Lives: ", style);
  ...
  lifetext.setShadow(3,3,'rgba(0,8,0,0.5)',2); 
// Create the stars
...
// Creating the player sprite player 
 game.add.sprite(32, 480, 'dude');
  // Animating the player sprite 
   player.animations.add('left',[0, 1, 2, 3],10,true);
   player.animations.add('right',[5, 6, 7,8],10,true); 
   game.physics.arcade.enable(player);
   ...
   // Animate the enemy1
    ...
    game. physics.arcade.enable(enemy1); enemy1.body.bounce.y = 0.2;
...
//resets the player's velocity if no events
...
function moveEnemy(){
 //enemy AI 
 if(enemy1.x > 759){ 
   enemy1.animations.play('Ieft');
    enemy1.body.velocity.x = -12e; }
   else if(enemyl.x < 485){ 
